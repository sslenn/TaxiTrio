...
export default function AdminLayout() {
  ...
  return (
    <div className="min-h-screen flex flex-col lg:flex-row bg-[#0B0B0B] text-white">
      ...
      {/* Sidebar Navigation */}
      <aside 
        className={`w-64 bg-[#0E0E0E] border-r border-gold/10 flex flex-col p-6 gap-2 shrink-0 fixed inset-y-0 left-0 z-50 transition-transform duration-300 transform lg:translate-x-0 lg:sticky lg:top-0 lg:h-screen lg:self-start lg:z-10 overflow-y-auto ${
